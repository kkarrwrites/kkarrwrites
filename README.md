...
- Hello! 👋 I'm K. Karr. I specialize in front end web development, particularly in `.md` `.html` `.css` `.scss` `.js` `.jsx` and `.astro`.
...
- In the past:
  - I've worked on various projects, which are listed on my [portfolio](https://kkarrwrites.carrd.co/).
...
- In the past, I've completed:
  ...
  - [CS50x 2024 Introduction to Computer Science](https://www.edx.org/learn/computer-science/harvard-university-cs50-s-introduction-to-computer-science) (Audit Track), HarvardX, edX (March 2025)
